...
export const PRAYERS = {
  ...
  apostlesCreed: {
    ...
    text: {
      ...
      kok: "Sotman'tam Devak, sarv padvedara Bapak, sarga ani prithumicha rachnarak; ani Jesu Kristak, tacha ekleach putak, amcha somiak; to pavitr atmia varvi garbhim sambhavlo, ankvar Marie thavn zanmalo. Pons Pilatakhal tanne kaxt sosle, taka khursar zoddlo, to melo ani taka nikhipilo. To mellea madhe denvlo, tisrea disa melleantlo jivant zalo, sargar chadlo, sarv padvedar deva bapacha ujveak basla. Thaim thavn jivea ani melleanchi mansubi karunk ietolo. Satmanta Pavitr atmiak, Katolik Pavitr Sabhek, bhaktancho ektar patkanche bogsannem, kuddiche jivantpann, sasnache jivit. Amen.",
    },
  },
  ...
  ourFather: {
    ...
    text: {
      ...
      kok: 'Amcha Bapa sargincha, tuje naanv pavitr zaanv, tuje raaz amkam ienv, tuji khushi sargar zata tashi sansarant zaanv. Amcho dispato gras aaz amkam di, ani ami amcher chukeleank bogsitanv, tashe amchi patkam bogas. Ani amkam tallnent padunk deenvnaka, pun vaitantlim amkam nivar. Amen.',
    },
  },
  ...
  hailMary: {
    ...
    text: {
      ...
      kok: 'Naman Marie kurpen bharlie, Somi tujie sangata, stria bhitar tu sadenv ani sadenvi foll tujie kusiche Jesu. Santa Marie, Devachie Maie, ama papiya khatir vinati kar, ata ani amcha mornachie kali. Amen.',
    },
  },
  ...
  gloryBe: {
    ...
    text: {
      ...
      kok: 'Anand Bapak ani Putak ani Pavitr Atmiak; jaso aadi, tasoch aata ani sada sarvata. Amen.',
    },
  },
  ...
  fatimaPrayer: {
    ...
    text: {
      ...
      kok: 'Ie mhojea Jesu amchi patkam amkam bogsi. Yamkondantlia ujiantlem amkam nivar. Samest atmiank, sargar tuji kakutichi adhi garz asleank sargar von tu pavay.',
    },
  },
  ...
  hailHolyQueen: {
    ...
    text: {
      ...
      kok: 'Naman Rannie, kakutichie Maie; naman amcha jiva, amrita ani bharvasea. Tuka ami ulo martanv, ami pardeshi Evechi ballka. Hea dukhancha kondant asta askar-huskar soddn ami tuka rudan kartanv. Tar tu amchie shekaye, te tujie kakutichie dolle amchie vair parti. Ani hea pardesha uprant tujie kusichie sadenvi foll Jesuk amkam dakai. Ie dayali, ie mogalli, ie dullobi ankvari Marie.',
    },
    versicle: {
      ...
      kok: { v: 'Bhagevant Devachie Maie ama pasat vinati kar.', r: 'Kristacha bhasavnyak ami favo zanvche khatir.' },
    },
    closingPrayer: {
...
export const ANGELUS = {
  ...
  versicles: [
    {
      v: {
        ...
        kok: 'Somiacha boddvean Mariek ijbi hadli.',
      },
      r: {
        ...
        kok: 'Ani Pavitr Atmia varvi ti garbest zali.',
      },
    },
    {
      v: {
      ...
      r: {
        ...
        kok: 'Tuja sabda parmane mhojie thaim zaanv.',
      },
    },
    {
      v: {
        ...
        kok: 'Ani Devacho Put Munis zalo.',
      },
      r: {
  ...
  closingPrayer: {
    ...
    kok: 'Prarthunya: Ie Somia boddveachie ijbe varvi tuja putan, Kristan, munshapan ghetle ami zana zaleanv: tacha kashta ani khursa varvi jivantpanacha anandak ami pavashe. Tuji kurpa amcha antaskarnani vot mhonn ami magtanv. Tyach Krista amchia Somia mariphat. Amen.',
  },
};
